          ...
          <div className="bg-white p-6 md:p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-200">
            ...
            <div className="space-y-6">
              <div className="flex gap-4">
                <img src="https://imgs.search.brave.com/L3hamAPlR5lyVT3buX591kjwHxkgD-6ZKGyv62qk50s/rs:fit:860:0:0:0/g:ce/aHR0cHM6Ly9zdGF0/aWMudmVjdGVlenku/Y29tL3N5c3RlbS9y/ZXNvdXJjZXMvdGh1/bWJuYWlscy8wNjkv/NDQ0LzQ3My9zbWFs/bC8zZC1yZW5kZXIt/c2VhcmNoLWVsZW1l/bnQtcG5nLnBuZw" alt="Browse Icon" className="h-12 w-12 flex-shrink-0" />
                <div>
                  <p className="font-bold text-lg">Browse and Discover</p>
                </div>
              </div>
              <div className="flex gap-4">
                <img src="https://imgs.search.brave.com/99oIJQjkOyw0SOh5uPi4XhN_wxvc6HGTmD0Ce90OIoA/rs:fit:860:0:0:0/g:" alt="Book Icon" className="h-12 w-12 flex-shrink-0" />
                <div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8 mb-8">
            <div>
              ...
              <div className="flex flex-col gap-2 text-sm text-gray-600">
                <button onClick={() => navigate('/')} className="hover:text-[#3593A6] cursor-pointer transition">About Us</button>
                <button onClick={() => {const token = localStorage.getItem('token'); if(!token) navigate('/login'); else navigate('/explore')}} className="hover:text-[#3593A6] cursor-pointer transition">Events</button>
                <button onClick={() => navigate('/')} className="hover:text-[#3593A6] cursor-pointer transition">Blog</button>
              </div>
            </div>
            <div>
              <p className="font-bold text-lg mb-3 text-[#111418]">Support</p>
              <div className="flex flex-col gap-2 text-sm text-gray-600">
                <button onClick={() => navigate('/')} className="hover:text-[#3593A6] cursor-pointer transition">Help Center</button>
                <button onClick={() => navigate('/')} className="hover:text-[#3593A6] cursor-pointer transition">Contact Us</button>
                <button onClick={() => navigate('/')} className="hover:text-[#3593A6] cursor-pointer transition">FAQ</button>
              </div>
            </div>
            <div>
              <p className="font-bold text-lg mb-3 text-[#111418]">Legal</p>
              <div className="flex flex-col gap-2 text-sm text-gray-600">
                <button onClick={() => navigate('/')} className="hover:text-[#3593A6] cursor-pointer transition">Privacy Policy</button>
                <button onClick={() => navigate('/')} className="hover:text-[#3593A6] cursor-pointer transition">Terms of Service</button>
              </div>
            </div>
            <div>
              <p className="font-bold text-lg mb-3 text-[#111418]">Follow Us</p>
              <div className="flex gap-3">
                <img src="https://ichef.bbci.co.uk/news/1024/branded_news/C5CC/production/_89663605_instagram_logo_976.jpg" alt="Instagram" className="h-8 w-8 cursor-pointer hover:opacity-80 transition" />
                <img src="https://content.linkedin.com/content/dam/me/business/en-us/amp/xbu/linkedin-revised-brand-guidelines/home/fg/brand-homepg-guidance-inlogo-dsk-v01.jpg.original.jpg" alt="LinkedIn" className="h-8 w-8 cursor-pointer hover:opacity-80 transition" />
                <img src="https://1000logos.net/wp-content/uploads/2017/02/Facebook-Logosu.png" alt="Facebook" className="h-8 w-8 cursor-pointer hover:opacity-80 transition" />
              </div>
            </div>
          </div>
        </div>
        <div className="h-1 bg-[#3593A6]"></div>
