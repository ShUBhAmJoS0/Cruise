...
function ArtistRequestDashboard({ onLogout, onNavigate }) {
        ...
        <div className="flex flex-col h-full p-4 justify-between">
          <div className="flex flex-col gap-8">
            <div className="flex flex-col px-2">
              ...
              <p className="text-[#617589] text-xs font-medium uppercase tracking-wider mt-1">Event Management</p>
            </div>
            
            <nav className="flex flex-col gap-2">
              <a onClick={() => onNavigate && onNavigate('event-requests')} className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-[#617589] hover:bg-[#f0f2f4] transition-colors group cursor-pointer">
              ...
              <a className="flex items-center gap-3 px-3 py-2.5 rounded-lg bg-[#3593A6]/10 text-[#3593A6]" href="#">
              ...
              <a onClick={() => {
                ...
                if (!token) {
                  ...
                  onNavigate && onNavigate('artists');
                }
              }} className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-[#617589] hover:bg-[#f0f2f4] transition-colors group cursor-pointer">
                <svg className="w-6 h-6 group-hover:text-[#3593A6] transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export default function App({ onLogout }) {
  const [currentPage, setCurrentPage] = useState('event-requests');

  const handleNavigate = (page) => {
    setCurrentPage(page);
  };

  return <ArtistRequestDashboard onLogout={onLogout} onNavigate={handleNavigate} />;
}